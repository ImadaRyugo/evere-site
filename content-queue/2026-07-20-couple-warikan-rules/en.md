...
There's data showing how far apart partners' unspoken assumptions can be. In [a 2024 survey in Japan by ONE FOR ONE](https://prtimes.jp/main/html/rd/p/000000006.000134744.html) of about 100 men and women in their 20s–30s, 57% of men privately preferred splitting the bill, while 52% of women hoped to be treated — nearly opposite expectations. Meanwhile, [a dating-expenses survey by Leading Tech](https://kyodonewsprwire.jp/release/202101250154) (2021) found men actually paid more than double per date on average (¥6,805 vs. ¥2,612, roughly $45 vs. $17). There is no guarantee your two "obviously"s match — which is exactly why saying it out loud once is worth it.
...
1. **Rounding** — who absorbs the odd cents ("the higher earner," "whoever suggested the date")
2. **Big-ticket items** — set a threshold above which the normal rule doesn't apply (trips, appliances)
3. **Birthdays and anniversaries** — make the exceptions explicit ("the one celebrating pays")
4. **Single-person purchases** — picking up something at a convenience store *for* your partner isn't a shared expense
