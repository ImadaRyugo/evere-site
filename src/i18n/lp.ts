...
export const lp: Record<LpLocale, LpDict> = {
	...
	ja: {
		...
		supportPage: {
			...
			submit: '送信する',
			sending: '送信中…',
			success: '送信しました。通常2〜3営業日以内に返信いたします。',
	...
	en: {
		...
		supportPage: {
			...
			submit: 'Send message',
			sending: 'Sending…',
			success: 'Message sent. We usually reply within 2–3 business days.',
	...
	th: {
		...
		supportPage: {
			...
			submit: 'ส่งข้อความ',
			sending: 'กำลังส่ง…',
			success: 'ส่งเรียบร้อยแล้ว โดยปกติเราจะตอบกลับภายใน 2–3 วันทำการ',
	...
	ko: {
		...
		supportPage: {
			...
			submit: '보내기',
			sending: '전송 중…',
			success: '전송되었습니다. 보통 2–3영업일 이내에 답변드립니다.',
	...
	'zh-hans': {
		...
		supportPage: {
			...
			submit: '发送',
			sending: '发送中…',
			success: '已发送。我们通常会在 2–3 个工作日内回复。',
	...
	'zh-hant': {
		...
		supportPage: {
			...
			submit: '送出',
			sending: '傳送中…',
			success: '已送出。我們通常會在 2–3 個工作日內回覆。',
